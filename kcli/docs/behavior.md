...
This page collects the parsing rules that matter in practice for the JavaScript
implementation.
...
- optional-value handlers consume values only when the next token looks like a
  value
