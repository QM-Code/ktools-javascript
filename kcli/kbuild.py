...
def _is_valid_kbuild_root(root_abs: str) -> bool:
    package_init = os.path.join(root_abs, "libs", "kbuild_js", "__init__.py")
...
def load_core_runner(root_abs: str):
    ...
    package_init = os.path.join(libs_dir, "kbuild_js", "__init__.py")
    ...
    try:
        from kbuild_js import run as run_core
